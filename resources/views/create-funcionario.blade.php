...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card mt-5">
                <div class="card-body">
                    <h5 class="card-title mb-4">Cadastro de Funcionário</h5>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error("nome") is-invalid @enderror" name="nome" value="{{old("nome")}}" id="inputNome" >
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error("cpf") is-invalid @enderror" name="cpf" value="{{old("cpf")}}" id="inputCpf">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error("carteira_trabalho") is-invalid @enderror" name="carteira_trabalho" value="{{old("carteira_trabalho")}}" id="inputPIS">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error("telefone_1") is-invalid @enderror" name="telefone_1" value="{{old("telefone_1")}}" id="inputTelefone1">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error("telefone_2") is-invalid @enderror" name="telefone_2" value="{{old("telefone_2")}}" id="inputTelefone2" aria-describedby="telefoneHelp">
